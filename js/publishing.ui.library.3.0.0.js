(function ($){
	...
	/* last update 2022.11.24 => add psAutoComplete search function*/
		...
		*/
			try{
				...
				var interval = setInterval(function() {
					if (time < $(options.animationClass).length){
						$(options.animationClass).eq(time).addClass(options.addClass.slice(0));
						time++;
					}else{
